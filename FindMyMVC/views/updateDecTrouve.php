...
<div class="container-fluid d-flex justify-content-center align-items-center " style="height: calc(100vh - 100px);">  
       ...
       <h3> préciser :</h3>
        <a href="/mesDeclarationsTrouve" type="button" class="btn-close" aria-label="Close" style="float:right"> </a>
<!-- declaration -->
    ...
    <!--tele -->
     ...
     <!-- despo -->
        ...
        <span class="input-group-text "> disponibilité </span>
            <input class="form-control " aria-label="With textarea" name="despo" value="<?= $model->despo?>"></input>
