...
<body>
    ...
    <body id="body-pd">
        <header class="header bg-light" id="header">
            <div class="header_toggle" > <i class='text-dark bx bx-menu fw-bold fs-5' id="header-toggle"></i> </div>
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                ...
                <div class="nav_list  d-flex  flex-column justify-content-center  h-100">
                        ...
                        <a href="#" class="nav_link"> <i class=' bx bx-line-chart nav_icon '></i> <span class="nav_name fs-5">statistique </span> </a>
                        <a href="Admin.php" class="nav_link"><i class='nav_icon bx bxs-user-detail'></i> <span class=" fs-5 nav_name">declaration privé</span> </a>
