...
<!-- Objet -->
       <div class="row">
        <div class="py-3  col ">
            ...
            <input type="text" class="p-1 border border-warning" name="objet" required>
        </div>
<!-- categorie -->
         <div class="col"> 
...
<!--  dateDePerd -->
            ...
            <div class="py-3 col ">
                ...
                <br>
                <input type="date" class="p-1 border border-warning" name="dateDePerd" required>
            </div>
<!-- ville  -->
       <div class="col">
        <label>  &#10038; Ville :</label>
        <select class="form-select " aria-label="Default select example" name="ville" required>
...
<!-- details -->
        ...
        <label>  &#10038;tele :</label>
        <div class="input-group mb-1 ">
        <input  class="p-1 border border-warning"  type="text" placeholder="telephone " name="tele" required>
        </div>
